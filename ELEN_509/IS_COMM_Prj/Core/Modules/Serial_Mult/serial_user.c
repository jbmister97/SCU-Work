...
uint8_t MB_rxBuffer[PC_RX_BUFFER_SIZE];
uint8_t MB_txBuffer[PC_TX_BUFFER_SIZE];

comm_buffer_t MB_inputBuffer = {0,0, MB_rxBuffer, MB_RX_BUFFER_SIZE, USART3};
comm_buffer_t MB_outputBuffer = {0,0, MB_txBuffer, MB_TX_BUFFER_SIZE, USART3};
